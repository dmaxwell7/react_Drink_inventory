...
export const Drinks = withRouter (( props:DrinksProps) => {
        ...
        <AppBar position="fixed" className={clsx(classes.appBar, {[classes.appBarShift]: open })}> {/* We are using MUI to make another navbar */}
            <Toolbar className={classes.toolbar}>
                ...
                <Typography variant="h6" className={classes.font} noWrap>
                    My Tequila Drink List
                </Typography>
                <Button className={classes.toolbar_button} onClick={handleDialogClickOpen}>Create New Tequila Drink</Button>

                {/* Dialog Pop Up */}
                <Dialog open={dialogOpen} onClose={handleDialogClickClose} aria-labelledby="form-dialog-title">
                    <DialogTitle id="form-dialog-title">Add New Tequila Drink</DialogTitle>
                    <DialogContent>
